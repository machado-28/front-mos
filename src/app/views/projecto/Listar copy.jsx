...
export default function Listar({ gestorId, clienteId }) {
    ...
    const buscarTotalProjectosLocal = async () => {
        setLoading((prev) => !prev);
        await api.listQuery(`projectos?gestorId=${gestorId}`).then((resp) => {
            console.log("pedidos", resp);
    ...
    return (
        <AppButtonRoot>
            ...
            <div className="w-100 d-flex  justify-content-between">
                <strong>Projectos  ({totalProjectos})   <Person></Person> </strong>
                <div>
                    <Link
                        onClick={() => {
