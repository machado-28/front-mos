import { Edit, FileDownloadDone, FilePresent, Folder, ManSharp, Print, SendAndArchive, Title } from "@mui/icons-material";
...
import Projectos from './../../projecto/Listar'
...
export default function Detalhar() {
    ...
    async function buscarGestores() {
        let gest = await Gestor.buscarTodos({ id: gestorId });
    ...
    return (
        <>
            ...
            <div className="p-4 w-100">
                ...
                <H2 className="mb-4">GESTOR DE PROJECTO <ManSharp></ManSharp></H2> <br></br>
                <h5>{gestor?.nome}</h5>
                <CNav variant="tabs">
                ...
                <CTabContent className="rounded-bottom">
                    <CTabPane data="trabalho" className="preview" visible={render === 0 ? true : false}>
                        <Resumo data={[{
                            name: "Projectos",
                            amount: gestor?.projectos?.length,
                            Icon: Folder,
                            path: "vistos/list",
                            bgColor: "warning"
                        },
                        {
                            name: "Processos",
                            amount: gestor?.processos?.length,
                            color: "black",
                            Icon: SendAndArchive,
                            bgColor: "info"
                        },
                    ...
                    <CTabPane className="preview border-1" visible={render === 6 ? true : false}>
                        <Box pt={2}></Box>
                        <Projectos gestorId clienteId></Projectos>
                    </CTabPane>
                </CTabContent>
            </div>
        </>
