    ...
    return (
      <AppButtonRoot>
        ...
        <div className="w-100 d-flex  justify-content-between">
          <h5>PROCESSOS ({totalSolicitacao}) </h5>
                      ...
                      ?.map((solicitacao, index) => (
                        <TableRow key={index} hover>
                          ...
                          <TableCell sx={{ px: 0 }} align="left" colSpan={2}>
                            ...
                            <CBadge className={solicitacao?.fromSite ? "bg-info text-black" : "bg-success text-white"}>  {solicitacao?.fromSite ? "Site" : "Local"}</CBadge>
