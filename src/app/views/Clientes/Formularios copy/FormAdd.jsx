        ...
        <CForm onSubmit={handleSubmit(PostData)} style={{ borderRadius: "none" }}>
            ...
            <CRow className="mb-4">
                ...
                <CCol>
                    ...
                    >
                        <option aria-readonly>selecione o cliente</option>
                        {listaPais?.map((pais) => (
                ...
                <CCol>
                    <CFormSelect
                        ...
                        {...register("nacionalidade")}
                    >
                        <option aria-readonly>selecione o responsavel interno</option>
                        {listaPais?.map((pais) => (
                            <option value={pais.name} key={pais.name}>
                                {pais.name}
                            </option>
                ...
                <CCol>
                    <CFormSelect
                        ...
                        required
                        {...register("respexterno")}
                    >
                        <option aria-readonly>selecione o responsavel externo</option>
                        {listaPais?.map((pais) => (
                            <option value={pais.name} key={pais.name}>
                                {pais.name}
                            </option>
