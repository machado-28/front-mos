...
export default function DashVisto() {
  ...
  const cardList = [
    ...
    { name: "Visto Cancelados ", amount: 0, Icon: Store },
    { name: "Processos Submetidos ", amount: totalPedidoSubmetido, Icon: Store },
    { name: "Pedidos do site", amount: 0, Icon: Store },
      ...
      <ContentBox className="analytics h-auto">
        <Grid container spacing={3}>
          <Grid item lg={8} md={8} sm={12} xs={12}>
            ...
            <SimpleCard style={{ height: "100px" }} title="Estatística dos Processos">
              <ComparisonChartGestorVisto
                height="250px"
