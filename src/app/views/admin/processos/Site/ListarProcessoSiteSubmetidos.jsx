...
export default function ListarProcessoSiteSubmetidos() {
  ...
  return (
    <AppButtonRoot>
      ...
      <Box py="12px" />
      <SimpleCard title="">
        <H3> LISTAGEM DE PROCESSO DO DE VISTO</H3>
      </SimpleCard>
      <Box py="12px" />
      <Card elevation={3} sx={{ pt: "20px", mb: 3 }}>
        <CardHeader>
          <Title>processos de visto ainda não examinados</Title>
                  ...
                  <TableRow key={index} hover>
                    ...
                    >
                      <Box display="flex" alignItems="center" gap={4}>
                        <Avatar src={processo?.avatarUrl} />
                        <Paragraph>{processo?.name}</Paragraph>
                      </Box>
                    </TableCell>
                    ...
                    <TableCell
                      ...
                      sx={{ px: 0, textTransform: "capitalize" }}
                    >
                      {processo?.createdAt > 999
                        ? (processo?.createdAt / 1000).toFixed(1) + "k"
                        : processo?.createdAt}
                    </TableCell>
