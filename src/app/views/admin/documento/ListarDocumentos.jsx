    ...
    <frameElement>
      <AppButtonRoot>
        ...
        {documentos?.map((documento, index) => {
          return (
            <>
              {documento?.anexo?.nome?.split(".")[1] !== "pdf" ? (
                <SimpleCard title={documento?.tipo?.nome}>
                  <div className="d'flex justify'content'between">
                    {
                      index == 0 ? <p>
                        <strong>data de Emissao:</strong>{documento?.dataEmissao}
                        <br></br>
                        <strong>data de Validade:</strong>{documento?.dataValidade}
                        <br></br>
                        <strong>Emissora: </strong>{documento?.emissora}
                      </p> : <></>
                    }
                    ...
                    <input id={documento?.anexoId} onChange={(e) => hanfleFile(e)} type="file" name="file"  ></input>
                    <label htmlFor="file">
