...
export default function ListardepartamentoLocalSubmetidos() {
                ...
                ?.map((departamento, index) => (
                  <TableRow key={index} hover>
                    ...
                    <TableCell
                      ...
                      sx={{ px: 0, textTransform: "capitalize" }}
                    >
                      {new Date(departamento?.createdAt).toLocaleString() > 999
                        ? (new Date(departamento?.createdAt).toLocaleString() / 1000).toFixed(1) + "k"
                        : new Date(departamento?.createdAt).toLocaleString()}
                    </TableCell>
                    ...
                    <TableCell
                      ...
                      sx={{ px: 0, textTransform: "capitalize" }}
                    >
                      {new Date(departamento?.createdAt).toDateString()}
                      {/* {new Date(departamento?.createdAt).toLocaleString() > 999
                        ? (new Date(departamento?.createdAt).toLocaleString() / 1000).toFixed(1) + "k"
                        : new Date(departamento?.createdAt).toLocaleString()} */}
                    </TableCell>
                    <TableCell sx={{ px: 0 }} colSpan={1}>
                      ...
                      <IconButton>
                        <Link to={"/departamento/detalhe/" + departamento?.id}>
                          {" "}
