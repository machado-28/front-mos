...
export default function ListarProcessoMIREMPETSubmetidos() {
 ...
 const [processos, setProcesos] = useState([
  ...
  async function ListarPedios() {
    await api.list("processos/status/6").then((response) => {
  ...
  return (
    <AppButtonRoot>
      ...
      <Box py="12px" />
      <SimpleCard title="">
        <H3> LISTAGEM DE PROCESSOS RECUSADOS PELO MIREMPET</H3>
      </SimpleCard>
      <Box py="12px" />
