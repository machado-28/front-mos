      ...
      <SimpleCard title="">
        ...
        <div>
          <p>
            ...
            <div>
              <div className=" d-flex justify-content-between">
                ...
                <article style={{ height: "10vh", width: "5vw" }}>
                  <Avatar className="h-100 w-100"></Avatar>
                </article>
              </div>
            </div>
          </p>
          ...
          <p>
            ...
            <i>
              {" "}
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequuntur at possimus
              consequatur voluptatum iusto laboriosam, ipsa animi incidunt
            </i>{" "}
            <br></br>
          </p>
          <Box py="12px" />
